...
class Book(models.Model):
    ...
    #Genre is already defined, so we can just specify the object
    ...
    def get_absolute_url(self):
        ...
        return reverse('book-detail', args=[str(self.id)]) #deve ser associada a uma view e template
...
class BookInstance(models.Model):
    ...
    class Meta:
        ordering = ['due_back'] #ordenação
        permissions = (('can_mark_returned' , 'Set book as returned'),) #define as permissões
